    ...
    , TOP{this, namep}
{
    ...
    // Setup scopes
    __Vscope_basys3_7seg_driver_tb.configure(this, name(), "basys3_7seg_driver_tb", "basys3_7seg_driver_tb", -3, VerilatedScope::SCOPE_OTHER);
    __Vscope_basys3_7seg_driver_tb__sim.configure(this, name(), "basys3_7seg_driver_tb.sim", "sim", -3, VerilatedScope::SCOPE_OTHER);
}
