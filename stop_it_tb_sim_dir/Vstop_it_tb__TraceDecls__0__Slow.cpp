...
void Vstop_it_tb___024root__traceDeclTypesSub0(VerilatedFst* tracep) {
    {
        ...
        = {"0", "1", "10", "11", "100", "101"};
        tracep->declDTypeEnum(1, "stop_it_pkg__Vdedup0::state_t", 6, 5, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        = {"WAITING_TO_START", "STARTING", "DECREMENTING", 
        ...
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11", "100", "101"};
        tracep->declDTypeEnum(2, "stop_it_pkg::state_t", 6, 5, __VenumItemNames, __VenumItemValues);
    }
}
